...
export default function EditSportsPage() {
  ...
  const fetchAchievement = async () => {
    try {
      const response = await fetch(`/api/sports/${achievementId}`)
      const data = await response.json()

      if (!response.ok) {
        throw new Error(data.error || 'Failed to fetch achievement')
      }
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="lg:pl-64 p-6 lg:p-8">
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-gray-600">Loading achievement...</p>
          </div>
        </main>
      </div>
    )
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="lg:ml-64 p-6 lg:p-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Edit Sports Achievement</h1>
